...
class SmartSearchDialogV2 extends StatefulWidget {
  ...
  @override
  State<SmartSearchDialogV2> createState() => _SmartSearchDialogV2State();
}

class _SmartSearchDialogV2State extends State<SmartSearchDialogV2> {
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
          children: [
            if (_searchQuery.isNotEmpty && _filteredAssignments.isNotEmpty) ...[
              _buildAssignmentsSection(),
              _buildDivider(),
            ],
            if (_searchQuery.isNotEmpty && _filteredStudents.isNotEmpty) ...[
              _buildStudentsSection(),
              if (_filteredClasses.isNotEmpty) _buildDivider(),
            ],
            if (_searchQuery.isNotEmpty && _filteredClasses.isNotEmpty) ...[
  ...
  Widget _buildResultItem({
    ...
    return InkWell(
      ...
      hoverColor: DesignColors.primary.withOpacity(0.05),
  ...
  Widget _buildFooter() {
    final totalResults = _filteredAssignments.length +
