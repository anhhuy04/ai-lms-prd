...
class SearchScreenConfig<T> {
  ...
  /// Nhận pageKey (int) và searchQuery (String?) để fetch dữ liệu theo trang
  final Future<List<T>> Function(int pageKey, String? searchQuery)
      fetchFunction;
