...
part 'teacher_dashboard_notifier.g.dart';
...
class TeacherDashboardNotifier extends _$TeacherDashboardNotifier {
  ...
  Future<void> refresh({bool showLoading = false}) async {
    ...
    try {
      // Refresh class list nếu có teacherId
      ...
      if (profile != null) {
        ...
        AppLogger.debug('🟢 [TEACHER_DASHBOARD] refresh data for user: ${profile.id}');
      }
      ...
      AppLogger.error(
        '🔴 [TEACHER_DASHBOARD] refresh lỗi: $e',
        error: e,
